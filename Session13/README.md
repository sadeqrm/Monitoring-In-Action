...
In this step, we will install and configure **Prometheus Server** using the provided script [`prometheusinstallation.sh`](./Promtheus Installation/prometheusinstallation.sh).  
